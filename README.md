...
This fork removes the Twitch bits integration and instead triggers events from [DonationAlerts](https://www.donationalerts.com/apidoc) donations. Enter your DonationAlerts token in the mod settings and configure prices in the loyalty store. When a donation amount matches a configured price an event will fire in game.
